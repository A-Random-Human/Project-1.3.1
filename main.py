...
def write_score(no_start_screen=True):
    score.goto(-300, 70)
    if no_start_screen:
        score.write("Score",
                    move=False,
        ...
        score.goto(-300, 30)
        score.color("white")
        score.write(player_score,
                    move=False,
                    align="left",
                    font=("Verdana", 30, "bold"))
    else:
        score.color("black")
        score.write("Press Space to Jump!",
                    move=False,
                    align="left",
                    font=("Verdana", 20, "normal"))
...
cloud_or_star = []
clouds_and_stars = [
    'cloud1.gif', 'cloud2.gif', 'cloud3.gif', 'cloud4.gif', 'cloud5.gif',
    'star1.gif', 'star2.gif', 'star3.gif'
]
...
def when_game_over(index):
    if (flappy_bird.xcor() + 10 > obstacles_up[index].xcor() - 50) and (
        (flappy_bird.ycor()) - 10 < obstacles_up[index].ycor() + 200):
        game_over()

    if (flappy_bird.xcor() + 10 > obstacles_down[index].xcor() - 50) and (
        (flappy_bird.ycor()) + 10 > obstacles_down[index].ycor() - 170):
        game_over()
